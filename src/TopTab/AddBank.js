  ...
  return (
    <View style={style.Container}>
      ...
      <View style={style.Viewblackborder}>
        ...
        <Text style={style.textcasino2}>Add bank details</Text>
      ...
      <View>
       ...
       <Text style={style.textmybets7}>Bank Name</Text>
      <TextInput style={style.bankname} placeholder='Bank Name'/>
      <Text style={style.textmybets6}>Account holder name</Text>
      <TextInput style={style.bankname} placeholder='Account holder name'/>

      <Text style={style.textmybets6}>Account number</Text>
      <TextInput style={style.bankname} placeholder='Account number'/>

      <Text style={style.textmybets6}>IFSC code</Text>
      <TextInput style={style.bankname} placeholder='IFSC code'/>

        <View style={style.viewdir}>
        <TouchableOpacity style={style.Profilebackbtn9}>
          <Text style={{color:"black",fontWeight:"400"}}>Reset</Text>
        </TouchableOpacity>
        <TouchableOpacity style={style.Profilebackbtn8}>
